...
export type YumNullable<Rule extends YumNullableRule, Yum extends YumNullableAccept> = {
  [Key in keyof Omit<Yum, keyof YumNullableType<Rule>>]: Key extends 'default'
    ? Rule extends true
      ? Yum[Key] | null
      : Exclude<Yum[Key], null>
    : Yum[Key];
...
export type YumRequired<Rule extends YumRequiredRule, Yum extends YumRequiredAccept> = {
  [Key in keyof Omit<Yum, keyof YumRequiredType<Rule>>]: Key extends 'default'
    ? Rule extends true
      ? Exclude<Yum[Key], undefined>
      : Yum[Key] | undefined
    : Yum[Key];
...
export type YumRange<Rule extends YumRangeRule, Yum extends YumRangeAccept> = Omit<Yum, keyof YumRangeType<Rule>> &
  YumRangeType<Rule>;
...
export type YumRegex<Rule extends YumRegexRule, Yum extends YumRegexAccept> = Omit<Yum, keyof YumRegexType<Rule>> &
  YumRegexType<Rule>;
...
export type YumFormat<Rule extends YumFormatRule, Yum extends YumFormatAccept> = Omit<Yum, keyof YumFormatType<Rule>> &
  YumFormatType<Rule>;
...
export type YumOr<Rule extends YumOrRule, Yum extends YumOrAccept> = {
  [Key in keyof Omit<Yum, keyof YumOrType<Rule>>]: Key extends 'default'
    ? YumDefault<Rule[number]> | YumExtractOptional<Yum[Key]>
    : Yum[Key];
} & YumOrType<Rule>;
...
export type YumOf<Rule extends YumOfRule, Yum extends YumOfAccept> = {
  [Key in keyof Omit<Yum, keyof YumOfType<Rule>>]: Key extends 'default'
    ? YumDefault<Rule>[] | YumExtractOptional<Yum[Key]>
    : Yum[Key];
} & YumOfType<Rule>;
...
export type YumShape<Rule extends YumShapeRule, Yum extends YumShapeAccept> = {
  [Key in keyof Omit<Yum, keyof YumShapeType<Rule>>]: Key extends 'default'
    ? YumShapeOutput<Rule> | YumExtractOptional<Yum[Key]>
    : Yum[Key];
} & YumShapeType<Rule>;
...
export type YumMerge<Extends extends YumExtendsTypeBase<Yum>, Yum extends YumTypeBase> = Omit<Yum, keyof Extends> & {
  [Key in keyof Extends]: Key extends 'default'
    ?
        | (Extends extends YumIncludeBase ? YumExtractOutput<Extends[Key]> : YumExtractOutput<Yum[Key]>)
        | (Extends extends YumNullableBase ? YumExtractNullable<Extends[Key]> : YumExtractNullable<Yum[Key]>)
        | (Extends extends YumRequiredBase ? YumExtractRequired<Extends[Key]> : YumExtractRequired<Yum[Key]>)
    : Extends[Key];
};
...
export type YumValidateCallback<Value = unknown, Return = void> = (
  context: YumTypeBase,
  value: Value,
...
export type YumExtendsTypeBase<Yum extends YumTypeBase> = Yum extends YumMixedBase
  ? YumMixedBase
  : Yum extends YumStringBase
  ? YumStringBase
  : Yum extends YumNumberBase
  ? YumNumberBase
  : Yum extends YumBooleanBase
  ? YumBooleanBase
  : Yum extends YumDateBase
  ? YumDateBase
  : Yum extends YumArrayBase
  ? YumArrayBase
  : Yum extends YumObjectBase
  ? YumObjectBase
  : YumTypeBase;
